...
internal abstract class IndexMappingTest {
    protected abstract class TestBuilderScope {
        ...
        open fun assertStraightRegion(virtualStart: UInt, realStart: UInt, length: UInt) {
        ...
        open fun assertMappedRegion(virtualStart: UInt, virtualLength: UInt, realStart: UInt, realLength: UInt) {
